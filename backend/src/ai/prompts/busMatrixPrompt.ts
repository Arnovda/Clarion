...
- No hard limit on table count — design as many dimensions and facts as the source data warrants.
  Typically 6-10 dimensions and 5-15 facts for a medium-sized source system.
  Prioritise complete coverage of all business processes over brevity.

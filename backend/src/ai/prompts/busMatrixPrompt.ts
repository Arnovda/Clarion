...
- Maximum 25 tables total (dims + facts). This is generous — be thorough but not redundant.
  Typically 6-8 dimensions and 8-15 facts for a medium-sized source system.
  Prioritise complete coverage of all business processes.
  If the source has more than 25 potential tables, merge related facts (e.g. orders + invoices → one fact).
...
- Keep column descriptions to one short sentence (< 15 words).
- Keep lineage entries minimal: only source_table_name, source_column_name, short transformation_description.
